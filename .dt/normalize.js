...
exports.normalizedIncludes = normalizedIncludes;
function normalizeText(input) {
    ...
    for (const ch of s) {
        ...
        if ((cp >= 0x0610 && cp <= 0x061a) || // honorific / quranic signs
        ...
        switch (cp) {
            ...
            case 0x0629:
                out += 'ه';
                break; // ة (تاء مربوطة) → ه
            // أوردو/فارسي:
            case 0x06cc:
                out += 'ي';
                break; // ی (ياء فارسية) → ي
            case 0x06a9:
                out += 'ك';
                break; // ک (كاف) → ك
            case 0x06af:
