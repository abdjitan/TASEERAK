...
export const SECTOR_PRODUCTS: Record<Sector, string[]> = {
  civil: [
    ...
    // المباني
    'طوب أحمر', 'طوب فارغ', 'بلوك خرساني', 'بلوك EPS عازل',
    // الهيكل
    'صلب هيكلي HEB', 'صلب هيكلي HEA', 'صلب هيكلي IPE', 'صفائح فولاذية',
    'أوتاد خرسانية', 'أوتاد حديد مجوف', 'عتبات جسور خرسانية',
    // الصرف والمواسير
    'أنابيب صرف صحي PVC', 'أنابيب صرف HDPE', 'أنابيب صرف خرساني',
    'غرف تفتيش خرسانية', 'أغطية منهول حديد',
    // مواد أخرى
    'شبك رابيتز', 'جير', 'جبصين', 'حجر طبيعي خام', 'مواد ردم',
    'مواد عازلة للأساسات', 'فيلم بولي ايثيلين',
  ],
  architectural: [
    // الأرضيات - من BOQ الحقيقي
    'بلاط بورسلين حجري FL-701',
    'بلاط سيراميك', 'بلاط بورسلين', 'بلاط بورسلين مستورد', 'رخام طبيعي',
    'جرانيت', 'باركيه خشبي', 'أرضية إيبوكسي', 'سجاد', 'فينيل',
    // الجدران والتشطيب
    'دهان أكريليك', 'دهان زيتي', 'دهان مضاد للرطوبة', 'ورق جدران',
    'جبس بورد', 'لواح GRC', 'لواح خشب MDF', 'كلادينج ألمنيوم',
    // الأسقف
    'أسقف مستعارة جبس', 'أسقف مستعارة معدنية', 'أسقف كالسيوم سيليكات',
    'بلاطات أسقف 600×600',
    // الأبواب والنوافذ
    'أبواب خشب داخلية', 'أبواب حديد مقاومة للحريق', 'أبواب ألمنيوم',
    'نوافذ ألمنيوم مزدوجة', 'نوافذ UPVC', 'ستائر حديد',
    // الواجهات والزجاج
    'زجاج عادي', 'زجاج عازل مزدوج', 'زجاج سيكوريت', 'زجاج رفلكتيف',
    'واجهات كومبوزيت', 'حجر بازلت', 'حجر صناعي',
    // العزل
    'فوم عازل حراري', 'صوف صخري', 'عازل XPS', 'عازل رطوبة للأسطح',
    'مواد عازلة للصوت',
    // الحمامات والمطابخ
    'سيراميك حمام', 'أدوات صحية', 'خلاطات مياه',
    // أخرى
    'قرميد سقف', 'مشربيات', 'درابزين ستانلس', 'سلالم حديد',
  ],
  electrical: [
    // الكابلات والأسلاك - مطابق لمعايير BOQ
    ...
    'كابل إنذار حريق', 'كابل بيانات CAT6', 'كابل ألياف بصرية',
    // لوحات التوزيع
    'لوحة توزيع رئيسية MDB', 'لوحة توزيع فرعية SDB',
    'لوحة توزيع إضاءة LDB', 'لوحة UPS', 'لوحة قواطع MCB',
    // القواطع والحماية
    'قاطع كهربائي MCB 1P', 'قاطع كهربائي MCB 3P',
    'قاطع تفاضلي RCCB', 'قاطع MCCB', 'قاطع هوائي ACB',
    // الإضاءة
    'لمبة LED بانل 60×60', 'لمبة LED بانل 30×120',
    'كشاف LED خارجي', 'كشاف LED صناعي', 'إضاءة طوارئ',
    'إضاءة شريطية LED', 'إضاءة مخرج طوارئ',
    // الأنظمة الكهربائية
    'محول كهربائي 11kV', 'محول كهربائي 400V',
    'لوحة MV متوسط جهد', 'مكثفات تحسين معامل القدرة',
    'مولد كهرباء ديزل', 'UPS لا انقطاعي',
    // المواسير والمسارات
    'أنابيب كهربائية PVC', 'أنابيب كهربائية معدنية',
    'سكة كابل مشبكة', 'سكة كابل مغطاة', 'علب توزيع',
    'مفاتيح وأبراز',
    // الأرضي والحماية
    'سلك تأريض', 'أقطاب تأريض', 'شريط نحاس تأريض',
    'برق حماية', 'جهاز كشف تسرب',
  ],
  mechanical: [
    // الأنابيب
    'أنابيب HDPE PN10', 'أنابيب HDPE PN16', 'أنابيب PPR PN20',
    'أنابيب PPR PN25', 'أنابيب PVC C', 'أنابيب GRE مقاومة كيماوي',
    'أنابيب نحاس', 'أنابيب CPVC مياه حارة', 'أنابيب PEX',
    'أنابيب فولاذية BS1387', 'أنابيب مياه إطفاء GRV',
    // الصمامات والتحكم
    'صمامات كرة نحاس', 'صمامات كرة ستانلس', 'صمامات بوابة',
    'صمامات فراشة', 'صمامات فحص', 'صمامات تخفيض ضغط',
    'صمامات تصريف', 'صمامات تحكم كهربائية',
    // المضخات
    'مضخات مياه مركزية', 'مضخة boosting ضغط', 'مضخة إطفاء حريق',
    'مضخة سمبرسبل صرف', 'مضخة دوسينج كيماوي',
    // التكييف والتهوية
    'وحدة مناولة هواء AHU', 'وحدة FCU سقفية', 'وحدة FCU خرطوم',
    'مكيفات VRV/VRF خارجية', 'مبرد مياه Chiller',
    'برج تبريد Cooling Tower', 'ضخ حراري Heat Pump',
    'مراوح هواء محورية', 'مراوح هواء طرد مركزي',
    // مجاري الهواء
    'مجاري هواء جلفنايز', 'مجاري هواء ستانلس', 'عوازل مجاري هواء',
    'فتحات هواء GI', 'موزعات هواء', 'ستائر هواء',
    // الصحية
    'خزان مياه فايبر جلاس', 'خزان ضغط', 'سخانات مياه مركزية',
    'سخانات مياه كهربائية', 'مرشحات مياه', 'أنظمة RO تحلية',
    'مضخات تداول مياه ساخنة', 'منظومة إطفاء Sprinkler',
    // الوصلات
    'فلانشات', 'وصلات أنابيب', 'عوازل اهتزاز', 'مواسير تمدد',
