...
export const PRODUCT_SPECS: Record<string, SpecField[]> = {
  ...
  // الخرسانة مسبقة الصب — منتج واحد، والعنصر (عتبة/عمود/بلاطة…) صار خياراً بدل منتجات منفصلة
  'خرسانة مسبقة الصب': [
    { key: 'element', ar: 'العنصر', en: 'Element', options: ['عتبات','أعمدة','بلاطات (Hollow Core)','كمرات / جسور','مدرجات','جدران (Panels)','درج','مقاطع خاصة'] },
    { key: 'strength', ar: 'قوة الخرسانة', en: 'Strength', options: ['C-30','C-35','C-40','C-45','C-50','حسب التصميم'] },
    { key: 'finish', ar: 'التشطيب', en: 'Finish', options: ['عادي','مكشوف (Fair Face)','حسب الطلب'] },
    { key: 'unit', ar: 'وحدة الطلب', en: 'Order unit', options: ['عدد','م³ (متر مكعب)','م.ط (متر طولي)','م² (متر مربع)'] },
  ],
  'بلوك خرساني': [
...
export const PRODUCT_TRANSLATIONS: Record<string, { en: string; ur: string }> = {
  ...
  // ── المعماري (architectural) — ترجمات مضافة ──
  ...
  // ── الكهرباء (electrical) — ترجمات مضافة ──
