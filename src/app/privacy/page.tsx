...
const C = {
  ...
  ur: {
    ...
    home: '🏠 مرکزی صفحہ',
    intro: 'تسعیرک آپ کی رازداری کا احترام کرتا ہے اور سعودی عرب کے ذاتی ڈیٹا کے تحفظ کے قانون (PDPL) کے مطابق آپ کے ڈیٹا کے تحفظ کا پابند ہے۔ یہ پالیسی واضح کرتی ہے کہ ہم کون سا ڈیٹا جمع کرتے ہیں اور اسے کیسے استعمال کرتے ہیں۔',
    note: 'نوٹ: یہ ابتدائی نسخہ ہے۔ ذاتی ڈیٹا کے تحفظ کے قانون سے مکمل مطابقت یقینی بنانے کے لیے کسی قانونی مشیر سے جائزہ لینے کی سفارش کی جاتی ہے۔',
    sections: [
      ['1. ہم کون سا ڈیٹا جمع کرتے ہیں', 'اکاؤنٹ کا ڈیٹا (ادارے کا نام، ای میل، فون)، تصدیقی ڈیٹا (تجارتی رجسٹریشن، لائسنس، ٹیکس نمبر)، مقام اور قومی پتہ، شعبے اور مہارتیں، اور استعمال کا ڈیٹا (قیمت کی درخواستیں، پیشکشیں، پیغامات)۔'],
      ['2. ہم آپ کا ڈیٹا کیسے استعمال کرتے ہیں', 'پلیٹ فارم چلانے، درخواستوں کو موزوں سپلائرز سے ملانے، اداروں کی تصدیق، اطلاعات بھیجنے، سروس بہتر بنانے اور قوانین کی پابندی کے لیے۔'],
      ['3. ڈیٹا کا اشتراک', 'جب کوئی پیشکش پیش یا قبول کی جاتی ہے تو لین دین مکمل کرنے کے لیے آپ کا ڈیٹا دوسرے فریق کے ساتھ شیئر کیا جاتا ہے، پلیٹ فارم چلانے والے قابلِ اعتماد سروس فراہم کنندگان (جیسے ہوسٹنگ اور ڈیٹابیس سروسز) کے ساتھ، اور تجارتی رجسٹریشن کی تصدیق کے لیے «واثق» گیٹ وے کے ساتھ۔ ہم آپ کا ڈیٹا کسی تیسرے فریق کو فروخت نہیں کرتے۔'],
      ['4. ذخیرہ اور سیکیورٹی', 'آپ کا ڈیٹا محفوظ انفراسٹرکچر پر محفوظ کیا جاتا ہے، پاسورڈ خفیہ کیے جاتے ہیں، اور حساس دستاویزات نجی اسٹوریج میں رکھی جاتی ہیں جن تک صرف صارف اور انتظامیہ رسائی رکھتے ہیں۔ ہم ڈیٹابیس کی سطح پر سخت رسائی کنٹرول (RLS) نافذ کرتے ہیں۔'],
      ['5. مدتِ حفاظت', 'ہم آپ کے ڈیٹا کو اس وقت تک محفوظ رکھتے ہیں جب تک آپ پلیٹ فارم استعمال کرتے ہیں اور جتنا قانونی مقاصد کے لیے ضروری ہو۔ آپ اپنے اکاؤنٹ کو حذف کرنے کی درخواست کر سکتے ہیں۔'],
      ['6. آپ کے حقوق', 'آپ کو قانون کی اجازت کے مطابق اپنے ڈیٹا تک رسائی، اس کی تصحیح یا حذف کی درخواست کا حق حاصل ہے۔ ان حقوق کے استعمال کے لیے ہم سے رابطہ کریں۔'],
      ['7. کوکیز', 'ہم لاگ اِن اور پلیٹ فارم کو درست چلانے کے لیے ضروری کوکیز استعمال کرتے ہیں۔'],
      ['8. کاروباری رازداری', 'یہ پلیٹ فارم اداروں اور کاروبار کے لیے ہے اور بچوں کے لیے نہیں۔'],
      ['9. تبدیلیاں', 'ہم اس پالیسی کو اپ ڈیٹ کر سکتے ہیں؛ اپ ڈیٹ پلیٹ فارم پر شائع ہوتے ہی نافذ العمل ہو جاتی ہے۔'],
      ['10. رابطہ', 'اپنی رازداری یا ڈیٹا کے بارے میں کسی سوال کے لیے، پلیٹ فارم کے سپورٹ چینلز کے ذریعے ہم سے رابطہ کریں۔'],
    ],
  },
}
